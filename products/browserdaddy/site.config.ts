...
export const site: SiteConfig = {
  ...
  socialImage: "/images/mark.png",
  tokens: storage.tokens,
  colorScheme: "dark",
  device: "desktop",
  hero: { kind: "artwork", image: "/images/mark.png", alt: "The green Daddy mascot used in the BrowserDaddy Mac app", caption: "Artwork from the development app, not a screenshot. Browsing-history captures are intentionally omitted." },
  gallery: [],
